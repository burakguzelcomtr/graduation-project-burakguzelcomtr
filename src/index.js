...
lessonManager.addUnit(mathLessonFor3rdGrade, mathLessonFor3rdGradeUnit1)
lessonManager.addUnit(mathLessonFor3rdGrade, mathLessonFor3rdGradeUnit2)

const algebraTopic = lessonManager.createTopic(generateId(), 'Algebra', 'Introduction to Algebra')
const biologyTopic = lessonManager.createTopic(generateId(), 'Algebra 2', 'Advanced Algebra Concepts')

const mathQuiz = lessonManager.createQuiz(generateId(), 'Math Quiz')
lessonManager.addLessonMaterial(mathLessonFor3rdGradeUnit1, generateId(), algebraTopic, 'topic', 0)
lessonManager.addLessonMaterial(mathLessonFor3rdGradeUnit1, generateId(), biologyTopic, 'topic', 1)
lessonManager.addLessonMaterial(mathLessonFor3rdGradeUnit1, generateId(), mathQuiz, 'quiz', 2)
